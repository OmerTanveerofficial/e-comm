  ...
  <main>
    ...
    <div className="bg-stone-50 dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800">
      <div className="container-main py-16 sm:py-20">
        ...
        <h1 className="animate-fade-up delay-100 font-serif font-bold text-4xl sm:text-5xl text-zinc-900 dark:text-zinc-50 leading-tight max-w-2xl">
          We built the store we always wanted to shop at.
        </h1>
        <p className="animate-fade-up delay-200 mt-5 text-base text-zinc-500 dark:text-zinc-400 max-w-xl leading-relaxed">
        ...
        <Link
          to="/products"
          className="animate-fade-up delay-300 mt-8 inline-flex items-center justify-center rounded-xl bg-zinc-900 dark:bg-zinc-100 px-6 py-3 text-sm font-semibold text-white dark:text-zinc-900 hover:bg-zinc-700 dark:hover:bg-zinc-200 active:scale-95 transition-all duration-150 shadow-sm"
        >
    ...
    <div className="bg-zinc-900 dark:bg-zinc-950">
      <div className="container-main py-12 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
        {[
          { num: '8+',   label: 'Product categories', delay: 0   },
          { num: '50k+', label: 'Happy customers',    delay: 100 },
          { num: '4.7★', label: 'Average rating',     delay: 200 },
          { num: '30',   label: 'Day return window',  delay: 300 },
        ].map(stat => (
          <div key={stat.label} className="animate-count-up" style={{ animationDelay: `${stat.delay}ms` }}>
